...
def import_ident_data(prev_start, prev_end, curr_start, curr_end, stakeholder_list):
    ...
    vs_data_vuln = iscore_vs_vuln(stakeholder_list)
    LOGGER.info("\tDone!")
    # ----- Retrieve PE data: -----
    LOGGER.info("Retrieving PE vuln data for I-Score...")
    pe_data_vuln = iscore_pe_vuln(stakeholder_list, curr_start, curr_end)
    LOGGER.info("\tDone!")
    LOGGER.info("Retrieving PE cred data for I-Score...")
    pe_data_cred = iscore_pe_cred(stakeholder_list, curr_start, curr_end)
    LOGGER.info("\tDone!")
    LOGGER.info("Retrieving PE breach data for I-Score...")
    pe_data_breach = iscore_pe_breach(stakeholder_list, curr_start, curr_end)
    LOGGER.info("\tDone!")
    LOGGER.info("Retrieving PE dark web data for I-Score...")
    pe_data_dw = iscore_pe_darkweb(stakeholder_list, curr_start, curr_end)
    LOGGER.info("\tDone!")
    LOGGER.info("Retrieving PE protocol data for I-Score...")
    pe_data_proto = iscore_pe_protocol(stakeholder_list, curr_start, curr_end)
    LOGGER.info("\tDone!")
    # ----- Retrieve WAS data: -----
    LOGGER.info("Retrieving WAS vuln data for I-Score...")
    was_data_vuln = iscore_was_vuln(stakeholder_list, curr_start, curr_end)
    LOGGER.info("\tDone!")

    # --------------- Import Historical Data: ---------------
    LOGGER.info("Retrieving previous VS vuln data for I-Score...")
    vs_data_vuln_prev = iscore_vs_vuln_prev(stakeholder_list, prev_start, prev_end)
    LOGGER.info("\tDone!")
    LOGGER.info("Retrieving previous PE vuln data for I-Score...")
    pe_data_vuln_prev = iscore_pe_vuln(stakeholder_list, prev_start, prev_end)
    LOGGER.info("\tDone!")
    LOGGER.info("Retrieving previous WAS vuln data for I-Score...")
    was_data_vuln_prev = iscore_was_vuln_prev(stakeholder_list, prev_start, prev_end)
    LOGGER.info("\tDone!")
