...
def init(
    ...
    curr_foreign_ips = foreign_ips.loc[(foreign_ips["timestamp"] >= curr_start) & (foreign_ips["timestamp"] <= curr_end)].reset_index(drop=True)
    past_foreign_ips = foreign_ips.loc[(foreign_ips["timestamp"] >= prev_start) & (foreign_ips["timestamp"] <= prev_end)].reset_index(drop=True)
