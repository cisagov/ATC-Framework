            ...
            if column_style_list[current_cell] is not None:
                if current_cell == 0:
                    ...
                    try:
                        ...
                        # Catch any formatting issues
                        print("*** Warning: issue encountered with format_anchor_table():")
                        print(e)
            current_row.append(cell)
            current_cell += 1
        data.append(current_row)
...
def report_gen_flare(data_dict, soc_med_included=False):
    ...
    Story.append(
        KeepTogether(
            [
                Paragraph(
                    f"3.4.{sub_section} Highest Risk Dark Web Posts", h3
                ),
                Paragraph(
                    f"""
                ...
                point12_spacer,
                doHeading(
                    "Table " + str(table_num) + ". Dark Web Posts and Risk Scores.", table
                ),
            ]
        )
    )
    ...
    Story.append(
        KeepTogether(
            [
                Paragraph(
                    f"3.4.{sub_section} Alerts of Potential Threats", h3
                ),
                Paragraph(
                    f"""
                ...
                point12_spacer,
                doHeading(
                    f"Table {table_num}. Alerts of Potential Threats.", table
                ),
            ]
        )
    )
    ...
    Story.append(
        KeepTogether(
            [
                ...
                point12_spacer,
                doHeading(
                    f"Table {table_num}. Market Alerts.", table
                ),
            ]
        )
    )
    ...
    Story.append(
        KeepTogether(
            [
                Paragraph(
                    f"3.4.{sub_section} Most Exploitable CVEs", h3
                ),
                Paragraph(
                    f"""
