...
class Assessment(models.Model):
    ...
    rsc_id = models.CharField(db_column="rsc_id", unique=True, max_length=255)
...
class Cve(models.Model):
    ...
    cvss_v2_base_score = models.CharField(
        db_column="cvss_v2_base_score", blank=True, null=True, max_length=255
    )
    cvss_v2_base_severity = models.CharField(
        db_column="cvss_v2_base_severity", blank=True, null=True, max_length=255
    )
    cvss_v2_exploitability_score = models.CharField(
        db_column="cvss_v2_exploitability_score", blank=True, null=True, max_length=255
    )
    ...
    cvss_v3_base_score = models.CharField(
        db_column="cvss_v3_base_score", blank=True, null=True, max_length=255
    )
    cvss_v3_base_severity = models.CharField(
        db_column="cvss_v3_base_severity", blank=True, null=True, max_length=255
    )
    cvss_v3_exploitability_score = models.CharField(
        db_column="cvss_v3_exploitability_score", blank=True, null=True, max_length=255
    )
    ...
    cvss_v4_base_score = models.CharField(
        db_column="cvss_v4_base_score", blank=True, null=True, max_length=255
    )
    cvss_v4_base_severity = models.CharField(
        db_column="cvss_v4_base_severity", blank=True, null=True, max_length=255
    )
    cvss_v4_exploitability_score = models.CharField(
        db_column="cvss_v4_exploitability_score", blank=True, null=True, max_length=255
    )
    cvss_v4_impact_score = models.CharField(
        db_column="cvss_v4_impact_score", blank=True, null=True, max_length=255
    )
...
class Question(models.Model):
    ...
    name = models.CharField(max_length=255)
    description = models.TextField(blank=True, null=True)
    long_form = models.TextField(db_column="long_form")
...
class SavedSearch(models.Model):
    ...
    updated_at = models.DateTimeField(db_column="updated_at")
    name = models.CharField(max_length=255)
    search_term = models.CharField(db_column="search_term", max_length=255)
    sort_direction = models.CharField(db_column="sort_direction", max_length=255)
    sort_field = models.CharField(db_column="sort_field", max_length=255)
    count = models.IntegerField()
    filters = models.JSONField()
    search_path = models.CharField(db_column="search_path", max_length=255)
...
class Webpage(models.Model):
    ...
    synced_at = models.DateTimeField(db_column="synced_at", blank=True, null=True)
    last_seen = models.DateTimeField(db_column="last_seen", blank=True, null=True)
    s3key = models.TextField(db_column="s3Key", blank=True, null=True)
    url = models.TextField()
    status = models.DecimalField(max_digits=100, decimal_places=5)
...
class Executives(models.Model):
    ...
    organization = models.ForeignKey(
        "Organization", on_delete=models.CASCADE, db_column="organization"
    )
...
class XpanseServicesMdl(models.Model):
    ...
    cves = models.ManyToManyField(XpanseCvesMdl, through="XpanseCveServiceMdl")
...
class XpanseCveServiceMdl(models.Model):
    ...
    xpanse_inferred_cve = models.ForeignKey(XpanseCvesMdl, on_delete=models.CASCADE)
    xpanse_service = models.ForeignKey(XpanseServicesMdl, on_delete=models.CASCADE)
...
class XpanseAlerts(models.Model):
    ...
    services = models.ManyToManyField(XpanseServicesMdl, related_name="alerts")
    assets = models.ManyToManyField(XpanseAssetsMdl, related_name="alerts")
