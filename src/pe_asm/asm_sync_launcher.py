...
def run_bash_in_screen(screen_name, bash_path):
    ...
    try:
        ...
        subprocess.run(send_command, check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
def launch_asm_sync_parts(num_parts):
    ...
    for i in range(1, num_parts+1):
        ...
        time.sleep(30)
    print(f"All ASM Sync script instances launched, monitor central logging file for progress")
